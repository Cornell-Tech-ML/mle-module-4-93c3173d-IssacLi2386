...
def default_log_fn(epoch, total_loss, time_per_epoch, correct, losses):
    print(
        "Epoch ",
        epoch,
        " loss ",
    ...
    def train(self, data, learning_rate, max_epochs=500, log_fn=default_log_fn):
        ...
        for epoch in range(max_epochs):
            ...
            if epoch % 10 == 0 or epoch == max_epochs:
                ...
                time_per_epoch = round(end - start, 2)
                log_fn(epoch, total_loss, time_per_epoch, correct, losses)
